...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::put('tomar_ticket', [App\Http\Controllers\TicketController::class, 'tomarTicket'])->name('tomar_ticket');
    Route::put('actualizar_estatus', [App\Http\Controllers\TicketController::class, 'actualizarEstatus'])->name('actualizar_estatus');
